...
export let lightingApi: typeof import('./client').lightingApi
...
export async function initializeApi(): Promise<void> {
  ...
  if (isLocalMode()) {
    ...
    lightingApi = remote.lightingApi
  }
